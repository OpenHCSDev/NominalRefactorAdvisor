...
projection from those declarations.  Common target and rationale fields use
``codemod_envelope_field`` when their enclosing record owns the projection.
No parallel schema is maintained.
