...
class SortedObservationAttribute:
    ...
    attribute_name: str
    def __get__(self, instance: ObservationGroup | None, owner: type[ObservationGroup]) -> tuple[str, ...] | SortedObservationAttribute:
        del owner
...
class ObservationGraph:
    ...
    def witness_groups_for(self, observation_kind: ObservationKind, execution_level: StructuralExecutionLevel) -> tuple[NominalWitnessGroup, ...]:
    ...
    def coherence_cohorts_for(self, observation_kind: ObservationKind, execution_level: StructuralExecutionLevel, minimum_witnesses: int=2, minimum_fibers: int=2) -> tuple[ObservationCohort, ...]:
...
def collect_structural_observations(parsed_module: ParsedModule) -> tuple[StructuralObservation, ...]:
