...
from .observation_shapes import AccessorWrapperCandidate, AttributeProbeObservation, BuilderCallShape, ClassMarkerObservation, ConfigDispatchObservation, DualAxisResolutionObservation, DynamicMethodInjectionObservation, ExportDictShape, FieldObservation, InterfaceGenerationObservation, LineageMappingObservation, LiteralDispatchObservation, LiteralKind, MethodShape, ProjectionHelperShape, RegistrationShape, RuntimeTypeGenerationObservation, ScopedShapeWrapperFunction, ScopedShapeWrapperSpec, SentinelTypeObservation
from .ast_tools import AstNameFamily, AssignObservationSpec, AutoRegisterMeta, AutoRegisteredModuleShapeSpec, ClassAstObservation, CollectedFamily, ContextForwardingShapeSpec, ContextHelperShapeSpec, FunctionObservationSpec, ObservationShapeSpec, ParsedModule, RegisteredSpecCollectedFamily, ScopedAstObservation, SingleSpecCollectedFamily, _ATTRIBUTE_ERROR_FAMILY, _GETATTR_CALL_FAMILY, _HASATTR_CALL_FAMILY, _REGISTRATION_CALL_FAMILY, _REGISTRATION_DECORATOR_FAMILY, _accessor_wrapper_candidate_from_function, _builder_call_shape, _class_body_field_observation, _class_marker_observations, _class_name_from_expr, _class_observations, _collect_items_from_spec_root, _config_dispatch_observations, _descendant_types, _dual_axis_resolution_observation, _dynamic_method_injection_observations, _execution_level_for_scope, _export_dict_shape, _fingerprint_builder_value, _init_field_observations, _inline_literal_dispatch_observations_for_kind, _interface_generation_observation, _iter_attribute_family_calls, _iter_class_decorator_family_calls, _known_class_family, _lineage_mapping_observation, _literal_dispatch_observations_for_kind, _node_display_name, _node_matches_family, _projection_helper_shape_from_function, _registration_key_fingerprint, _runtime_type_generation_observation, _scoped_shape_wrapper_function_from_function, _scoped_shape_wrapper_spec_from_assign, _sentinel_type_observation, _sentinel_type_usage_observations, _subscript_base_name, _terminal_name, _terminal_name_in_family
...
class ConfigDispatchObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, FunctionObservationSpec):
    _registry_root = True
...
class ScopeFilteredFunctionObservationSpec(FunctionObservationSpec, ABC):
    ...
    def build_from_function(self, parsed_module: ParsedModule, function: ast.FunctionDef | ast.AsyncFunctionDef, observation: ScopedAstObservation) -> object | None:
...
class ScopeFilteredAssignObservationSpec(AssignObservationSpec, ABC):
    ...
    def build_from_assign(self, parsed_module: ParsedModule, node: ast.Assign, observation: ScopedAstObservation) -> object | None:
        if not self.accepts_scope(observation): return None
...
class HelperBackedFunctionObservationSpec(FunctionAcceptanceMixin, FunctionObservationSpec, ABC):
...
class HelperBackedScopedFunctionObservationSpec(FunctionAcceptanceMixin, ScopeFilteredFunctionObservationSpec, ABC):
    shape_helper: ClassVar[Callable[..., object | None]]
    @staticmethod
    def wrap_helper_result(value: object | None) -> object | None: return value
    def accepts_function(self, function: ast.FunctionDef | ast.AsyncFunctionDef, observation: ScopedAstObservation) -> bool: del function, observation; return True
    def build_scoped_function(self, parsed_module: ParsedModule, function: ast.FunctionDef | ast.AsyncFunctionDef, observation: ScopedAstObservation) -> object | None:
        if not self.accepts_function(function, observation): return None
        return type(self).wrap_helper_result(type(self).shape_helper(parsed_module, function))
...
class StandardConfigDispatchObservationSpec(ConfigDispatchObservationSpec, ModuleOnlyFunctionObservationSpec, RequiredFunctionParameterMixin, TupleResultMixin, HelperBackedScopedFunctionObservationSpec):
    required_parameter_name = "config"
    shape_helper = _config_dispatch_observations
class ClassMarkerObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, FunctionObservationSpec):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(ClassMarkerObservation, ObservationFamily),)
class StandardClassMarkerObservationSpec(ClassMarkerObservationSpec, TupleResultMixin, HelperBackedFunctionObservationSpec):
    shape_helper = _class_marker_observations
class InterfaceGenerationObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, FunctionObservationSpec):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(InterfaceGenerationObservation, ObservationFamily),)
class StandardInterfaceGenerationObservationSpec(InterfaceGenerationObservationSpec, HelperBackedFunctionObservationSpec):
    shape_helper = _interface_generation_observation
class SentinelTypeObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, ABC):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(SentinelTypeObservation, ObservationFamily),)
class SentinelTypeAssignmentObservationSpec(SentinelTypeObservationSpec, ModuleOnlyAssignObservationSpec, HelperBackedScopedAssignObservationSpec):
...
class DynamicMethodInjectionObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, FunctionObservationSpec):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(DynamicMethodInjectionObservation, ObservationFamily),)
class StandardDynamicMethodInjectionObservationSpec(DynamicMethodInjectionObservationSpec, TupleResultMixin, HelperBackedFunctionObservationSpec):
    shape_helper = _dynamic_method_injection_observations
class RuntimeTypeGenerationObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, ObservationShapeSpec, ABC):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(RuntimeTypeGenerationObservation, ObservationFamily),)
class TypeCallGenerationObservationSpec(RuntimeTypeGenerationObservationSpec, ObservationContextHelperShapeSpec):
    node_type = ast.Call
    shape_helper = _runtime_type_generation_observation
class LineageMappingObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, AssignObservationSpec, ABC):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(LineageMappingObservation, ObservationFamily),)
class StandardLineageMappingObservationSpec(LineageMappingObservationSpec, HelperBackedAssignObservationSpec):
    shape_helper = _lineage_mapping_observation
class DualAxisResolutionObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, FunctionObservationSpec, ABC):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(DualAxisResolutionObservation, ObservationFamily),)
class StandardDualAxisResolutionObservationSpec(DualAxisResolutionObservationSpec, HelperBackedFunctionObservationSpec):
    shape_helper = _dual_axis_resolution_observation
class AttributeProbeObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, ABC):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(AttributeProbeObservation, ObservationFamily),)
class CallAttributeProbeObservationSpec(AttributeProbeObservationSpec, ContextForwardingShapeSpec, ABC):
    node_type = ast.Call
    _registry_skip = True
    ...
    def build_from_context(self, parsed_module: ParsedModule, node: ast.AST, observation: ScopedAstObservation) -> AttributeProbeObservation | None:
...
class GetAttrProbeObservationSpec(CallAttributeProbeObservationSpec):
    ...
    minimum_args = 3
    attribute_arg_index = 1
class AttributeErrorProbeObservationSpec(AttributeProbeObservationSpec, ObservationShapeSpec):
    @property
    def node_types(self) -> tuple[type[ast.AST], ...]: return (ast.Try,)
    def build_from_observation(self, parsed_module: ParsedModule, observation: ScopedAstObservation) -> AttributeProbeObservation | None:
...
class TypedLiteralObservationSpec(AutoRegisteredModuleShapeSpec, ABC):
    ...
    @classmethod
    def registered_specs_for_literal_type(cls, literal_type: type[object] | None=None) -> tuple[TypedLiteralObservationSpec, ...]:
...
class StringLiteralDispatchObservationSpec(FamilyGeneratingSpec, LiteralDispatchObservationSpec):
    family_specs = (GeneratedFamilySpec(LiteralDispatchObservation, TypedLiteralObservationFamily),)
    literal_type = str
    literal_kind = LiteralKind.STRING
class NumericLiteralDispatchObservationSpec(FamilyGeneratingSpec, LiteralDispatchObservationSpec):
    family_specs = (GeneratedFamilySpec(LiteralDispatchObservation, TypedLiteralObservationFamily),)
    literal_type = int
...
class InlineStringLiteralDispatchObservationSpec(FamilyGeneratingSpec, InlineLiteralDispatchObservationSpec):
    family_specs = (GeneratedFamilySpec(LiteralDispatchObservation, TypedLiteralObservationFamily),)
    literal_type = str
    literal_kind = LiteralKind.STRING
...
class AssignmentRegistrationShapeSpec(KnownClassFamilyShapeSpec):
    def collect_with_known_class_family(self, parsed_module: ParsedModule, known_class_family: AstNameFamily) -> list[object]:
        shapes: list[object] = []
...
class DataclassBodyFieldObservationSpec(ClassObservationSpec):
    def collect_for_class(self, parsed_module: ParsedModule, class_observation: ClassAstObservation) -> list[object]:
        observations: list[object] = []
...
class InitAssignmentFieldObservationSpec(ClassObservationSpec):
    def collect_for_class(self, parsed_module: ParsedModule, class_observation: ClassAstObservation) -> list[object]:
        ...
        return observations
class ProjectionHelperObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, FunctionObservationSpec, ABC):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(ProjectionHelperShape, ObservationFamily),)
class AccessorWrapperObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, FunctionObservationSpec, ABC):
    _registry_root = True
    family_specs = (GeneratedFamilySpec(AccessorWrapperCandidate, ObservationFamily),)
class StandardProjectionHelperObservationSpec(ProjectionHelperObservationSpec, ModuleOnlyFunctionObservationSpec, HelperBackedScopedFunctionObservationSpec):
    shape_helper = _projection_helper_shape_from_function
class StandardAccessorWrapperObservationSpec(AccessorWrapperObservationSpec, ClassNamedFunctionHelperObservationSpec):
    shape_helper = _accessor_wrapper_candidate_from_function
class ScopedShapeWrapperObservationSpec(FamilyGeneratingSpec, AutoRegisteredModuleShapeSpec, ABC):
    _registry_root = True
...
class ScopedShapeWrapperFunctionObservationSpec(ScopedShapeWrapperObservationSpec, ModuleOnlyFunctionObservationSpec, SyncFunctionOnlyMixin, HelperBackedScopedFunctionObservationSpec):
    shape_helper = _scoped_shape_wrapper_function_from_function
class ScopedShapeWrapperSpecObservationSpec(ScopedShapeWrapperObservationSpec, ModuleOnlyAssignObservationSpec, HelperBackedScopedAssignObservationSpec):
...
def _materialize_generated_family(spec_type: type[FamilyGeneratingSpec], family_spec: GeneratedFamilySpec) -> type[CollectedFamily]:
