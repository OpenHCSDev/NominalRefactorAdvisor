...
_ACCESSOR_WRAPPER_KEYWORD_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.ACCESSOR_WRAPPER, ObservationTag.KEYWORD_MAPPING, ObservationTag.NORMALIZED_AST)
_ATTRIBUTE_PROBE_CONFIG_DISPATCH_CLASS_FAMILY_OBSERVATION_TAGS = (ObservationTag.ATTRIBUTE_PROBE, ObservationTag.CONFIG_DISPATCH, ObservationTag.CLASS_FAMILY)
_ATTRIBUTE_PROBE_CONFIG_DISPATCH_OBSERVATION_TAGS = (ObservationTag.ATTRIBUTE_PROBE, ObservationTag.CONFIG_DISPATCH)
_ATTRIBUTE_PROBE_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.ATTRIBUTE_PROBE, ObservationTag.PARTIAL_VIEW)
_AUTHORITATIVE_AUTHORITATIVE_DISPATCH_NOMINAL_IDENTITY_SHARED_ALGORITHM_AUTHORITY_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.AUTHORITATIVE_DISPATCH, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.SHARED_ALGORITHM_AUTHORITY)
_AUTHORITATIVE_CLOSED_FAMILY_DISPATCH_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.CLOSED_FAMILY_DISPATCH, CapabilityTag.NOMINAL_IDENTITY)
_AUTHORITATIVE_DISPATCH_AUTHORITATIVE_NOMINAL_IDENTITY_SHARED_ALGORITHM_AUTHORITY_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_DISPATCH, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.SHARED_ALGORITHM_AUTHORITY)
_AUTHORITATIVE_DISPATCH_NOMINAL_IDENTITY_MRO_ORDERING_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_DISPATCH, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.MRO_ORDERING)
_AUTHORITATIVE_FAIL_LOUD_CONTRACTS_PROVENANCE_TYPE_LINEAGE_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.FAIL_LOUD_CONTRACTS, CapabilityTag.PROVENANCE, CapabilityTag.TYPE_LINEAGE)
_AUTHORITATIVE_NOMINAL_IDENTITY_UNIT_RATE_COHERENCE_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.UNIT_RATE_COHERENCE)
_AUTHORITATIVE_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.PROVENANCE)
_AUTHORITATIVE_PROVENANCE_SHARED_ALGORITHM_AUTHORITY_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.PROVENANCE, CapabilityTag.SHARED_ALGORITHM_AUTHORITY)
_AUTHORITATIVE_SHARED_ALGORITHM_AUTHORITY_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.PROVENANCE)
_AUTHORITATIVE_SHARED_ALGORITHM_AUTHORITY_UNIT_RATE_COHERENCE_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.UNIT_RATE_COHERENCE)
_AUTHORITATIVE_UNIT_RATE_COHERENCE_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.UNIT_RATE_COHERENCE, CapabilityTag.PROVENANCE)
_BIDIRECTIONAL_NORMALIZATION_EXACT_LOOKUP_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.BIDIRECTIONAL_NORMALIZATION, CapabilityTag.EXACT_LOOKUP, CapabilityTag.PROVENANCE)
_BRANCH_DISPATCH_CLASS_FAMILY_DATAFLOW_ROOT_OBSERVATION_TAGS = (ObservationTag.BRANCH_DISPATCH, ObservationTag.CLASS_FAMILY, ObservationTag.DATAFLOW_ROOT)
_BRANCH_DISPATCH_PROJECTION_DICT_OBSERVATION_TAGS = (ObservationTag.BRANCH_DISPATCH, ObservationTag.PROJECTION_DICT)
_BUILDER_CALL_CLASS_FAMILY_DATAFLOW_ROOT_OBSERVATION_TAGS = (ObservationTag.BUILDER_CALL, ObservationTag.CLASS_FAMILY, ObservationTag.DATAFLOW_ROOT)
_BUILDER_CALL_DATAFLOW_ROOT_PREDICATE_CHAIN_OBSERVATION_TAGS = (ObservationTag.BUILDER_CALL, ObservationTag.DATAFLOW_ROOT, ObservationTag.PREDICATE_CHAIN)
_BUILDER_CALL_DATAFLOW_ROOT_SCOPED_SHAPE_WRAPPER_OBSERVATION_TAGS = (ObservationTag.BUILDER_CALL, ObservationTag.DATAFLOW_ROOT, ObservationTag.SCOPED_SHAPE_WRAPPER)
_CAPABILITY_MARKER_IDENTITY_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.CAPABILITY_MARKER_IDENTITY, CapabilityTag.NOMINAL_IDENTITY)
_CLASS_FAMILY_DATAFLOW_ROOT_BUILDER_CALL_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.DATAFLOW_ROOT, ObservationTag.BUILDER_CALL)
_CLASS_FAMILY_DATAFLOW_ROOT_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.DATAFLOW_ROOT)
_CLASS_FAMILY_DATAFLOW_ROOT_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.DATAFLOW_ROOT, ObservationTag.PARTIAL_VIEW)
_CLASS_FAMILY_FACTORY_DISPATCH_REPEATED_METHOD_ROLES_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.FACTORY_DISPATCH, ObservationTag.REPEATED_METHOD_ROLES)
_CLASS_FAMILY_MANUAL_SYNCHRONIZATION_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.MANUAL_SYNCHRONIZATION)
_CLASS_FAMILY_METHOD_ROLE_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.METHOD_ROLE, ObservationTag.NORMALIZED_AST)
_CLASS_FAMILY_METHOD_ROLE_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.METHOD_ROLE, ObservationTag.PARTIAL_VIEW)
_CLASS_FAMILY_NORMALIZED_AST_MANUAL_SYNCHRONIZATION_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.NORMALIZED_AST, ObservationTag.MANUAL_SYNCHRONIZATION)
_CLASS_FAMILY_PREDICATE_CHAIN_REGISTRY_POPULATION_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.PREDICATE_CHAIN, ObservationTag.REGISTRY_POPULATION)
_CLASS_FAMILY_REGISTRY_POPULATION_REPEATED_METHOD_ROLES_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.REGISTRY_POPULATION, ObservationTag.REPEATED_METHOD_ROLES)
_CLASS_FAMILY_REPEATED_METHOD_ROLES_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.REPEATED_METHOD_ROLES)
_CLASS_FAMILY_REPEATED_METHOD_ROLES_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.REPEATED_METHOD_ROLES, ObservationTag.PARTIAL_VIEW)
_CLASS_FAMILY_RUNTIME_MEMBERSHIP_OBSERVATION_TAGS = (ObservationTag.CLASS_FAMILY, ObservationTag.RUNTIME_MEMBERSHIP)
_CLASS_LEVEL_REGISTRATION_AUTHORITATIVE_DISPATCH_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.CLASS_LEVEL_REGISTRATION, CapabilityTag.AUTHORITATIVE_DISPATCH, CapabilityTag.NOMINAL_IDENTITY)
_CLASS_LEVEL_REGISTRATION_AUTHORITATIVE_ENUMERATION_CAPABILITY_TAGS = (CapabilityTag.CLASS_LEVEL_REGISTRATION, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.ENUMERATION)
_CLASS_LEVEL_REGISTRATION_AUTHORITATIVE_SHARED_ALGORITHM_AUTHORITY_CAPABILITY_TAGS = (CapabilityTag.CLASS_LEVEL_REGISTRATION, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.SHARED_ALGORITHM_AUTHORITY)
_CLASS_LEVEL_REGISTRATION_NOMINAL_IDENTITY_MRO_ORDERING_CAPABILITY_TAGS = (CapabilityTag.CLASS_LEVEL_REGISTRATION, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.MRO_ORDERING)
_CLASS_LEVEL_REGISTRATION_NOMINAL_IDENTITY_SHARED_ALGORITHM_AUTHORITY_CAPABILITY_TAGS = (CapabilityTag.CLASS_LEVEL_REGISTRATION, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.SHARED_ALGORITHM_AUTHORITY)
_CLASS_LEVEL_REGISTRATION_PROVENANCE_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.CLASS_LEVEL_REGISTRATION, CapabilityTag.PROVENANCE, CapabilityTag.NOMINAL_IDENTITY)
_CLASS_MARKER_PROBE_RUNTIME_MEMBERSHIP_OBSERVATION_TAGS = (ObservationTag.CLASS_MARKER_PROBE, ObservationTag.RUNTIME_MEMBERSHIP)
_CLOSED_FAMILY_DISPATCH_AUTHORITATIVE_DISPATCH_SHARED_ALGORITHM_AUTHORITY_CAPABILITY_TAGS = (CapabilityTag.CLOSED_FAMILY_DISPATCH, CapabilityTag.AUTHORITATIVE_DISPATCH, CapabilityTag.SHARED_ALGORITHM_AUTHORITY)
_CLOSED_FAMILY_DISPATCH_AUTHORITATIVE_DISPATCH_UNIT_RATE_COHERENCE_CAPABILITY_TAGS = (CapabilityTag.CLOSED_FAMILY_DISPATCH, CapabilityTag.AUTHORITATIVE_DISPATCH, CapabilityTag.UNIT_RATE_COHERENCE)
_CLOSED_FAMILY_DISPATCH_AUTHORITATIVE_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.CLOSED_FAMILY_DISPATCH, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.NOMINAL_IDENTITY)
_CLOSED_FAMILY_DISPATCH_NOMINAL_IDENTITY_FAIL_LOUD_CONTRACTS_CAPABILITY_TAGS = (CapabilityTag.CLOSED_FAMILY_DISPATCH, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.FAIL_LOUD_CONTRACTS)
_DATAFLOW_ROOT_PARTIAL_VIEW_CLASS_FAMILY_OBSERVATION_TAGS = (ObservationTag.DATAFLOW_ROOT, ObservationTag.PARTIAL_VIEW, ObservationTag.CLASS_FAMILY)
_DUAL_AXIS_RESOLUTION_PROVENANCE_MRO_ORDERING_CAPABILITY_TAGS = (CapabilityTag.DUAL_AXIS_RESOLUTION, CapabilityTag.PROVENANCE, CapabilityTag.MRO_ORDERING)
_DYNAMIC_METHOD_INJECTION_TYPE_NAMESPACE_OBSERVATION_TAGS = (ObservationTag.DYNAMIC_METHOD_INJECTION, ObservationTag.TYPE_NAMESPACE)
_ENUMERATION_CLOSED_FAMILY_DISPATCH_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.ENUMERATION, CapabilityTag.CLOSED_FAMILY_DISPATCH, CapabilityTag.NOMINAL_IDENTITY)
_EXPORT_NORMALIZED_AST_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.EXPORT_MAPPING, ObservationTag.NORMALIZED_AST, ObservationTag.PARTIAL_VIEW)
_FAIL_LOUD_CONTRACTS_NOMINAL_IDENTITY_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.FAIL_LOUD_CONTRACTS, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.PROVENANCE)
_FAIL_LOUD_CONTRACTS_SHARED_ALGORITHM_AUTHORITY_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.FAIL_LOUD_CONTRACTS, CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.NOMINAL_IDENTITY)
_GENERATED_INTERFACE_IDENTITY_VIRTUAL_MEMBERSHIP_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.GENERATED_INTERFACE_IDENTITY, CapabilityTag.VIRTUAL_MEMBERSHIP, CapabilityTag.NOMINAL_IDENTITY)
_INTERFACE_IDENTITY_CLASS_FAMILY_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.INTERFACE_IDENTITY, ObservationTag.CLASS_FAMILY, ObservationTag.NORMALIZED_AST)
_KEYWORD_BUILDER_CALL_DATAFLOW_ROOT_OBSERVATION_TAGS = (ObservationTag.KEYWORD_MAPPING, ObservationTag.BUILDER_CALL, ObservationTag.DATAFLOW_ROOT)
_KEYWORD_BUILDER_CALL_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.KEYWORD_MAPPING, ObservationTag.BUILDER_CALL, ObservationTag.NORMALIZED_AST)
_KEYWORD_NORMALIZED_AST_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.KEYWORD_MAPPING, ObservationTag.NORMALIZED_AST, ObservationTag.PARTIAL_VIEW)
_LITERAL_BRANCH_DISPATCH_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.LITERAL_BRANCH_DISPATCH, ObservationTag.PARTIAL_VIEW)
_LITERAL_ID_DISPATCH_NORMALIZED_AST_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.LITERAL_ID_DISPATCH, ObservationTag.NORMALIZED_AST, ObservationTag.PARTIAL_VIEW)
_LITERAL_ID_DISPATCH_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.LITERAL_ID_DISPATCH, ObservationTag.PARTIAL_VIEW)
_METHOD_ROLE_DATAFLOW_ROOT_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.METHOD_ROLE, ObservationTag.DATAFLOW_ROOT, ObservationTag.PARTIAL_VIEW)
_METHOD_ROLE_NORMALIZED_AST_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.METHOD_ROLE, ObservationTag.NORMALIZED_AST, ObservationTag.PARTIAL_VIEW)
_METHOD_ROLE_PARTIAL_VIEW_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.METHOD_ROLE, ObservationTag.PARTIAL_VIEW, ObservationTag.NORMALIZED_AST)
_NESTED_PRECEDENCE_WALK_SCOPE_HIERARCHY_MRO_HIERARCHY_OBSERVATION_TAGS = (ObservationTag.NESTED_PRECEDENCE_WALK, ObservationTag.SCOPE_HIERARCHY, ObservationTag.MRO_HIERARCHY)
_NOMINAL_IDENTITY_AUTHORITATIVE_MRO_ORDERING_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.MRO_ORDERING)
_NOMINAL_IDENTITY_AUTHORITATIVE_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.PROVENANCE)
_NOMINAL_IDENTITY_ENUMERATION_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.ENUMERATION, CapabilityTag.PROVENANCE)
_NOMINAL_IDENTITY_FAIL_LOUD_CONTRACTS_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.FAIL_LOUD_CONTRACTS)
_NOMINAL_IDENTITY_FAIL_LOUD_CONTRACTS_MRO_ORDERING_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.FAIL_LOUD_CONTRACTS, CapabilityTag.MRO_ORDERING)
_NOMINAL_IDENTITY_FAIL_LOUD_CONTRACTS_VIRTUAL_MEMBERSHIP_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.FAIL_LOUD_CONTRACTS, CapabilityTag.VIRTUAL_MEMBERSHIP)
_NOMINAL_IDENTITY_MRO_ORDERING_SHARED_ALGORITHM_AUTHORITY_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.MRO_ORDERING, CapabilityTag.SHARED_ALGORITHM_AUTHORITY)
_NOMINAL_IDENTITY_PROVENANCE_AUTHORITATIVE_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.PROVENANCE, CapabilityTag.AUTHORITATIVE_MAPPING)
_NOMINAL_IDENTITY_PROVENANCE_FAIL_LOUD_CONTRACTS_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.PROVENANCE, CapabilityTag.FAIL_LOUD_CONTRACTS)
_NOMINAL_IDENTITY_SHARED_ALGORITHM_AUTHORITY_MRO_ORDERING_CAPABILITY_TAGS = (CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.MRO_ORDERING)
_NORMALIZED_AST_CLASS_FAMILY_METHOD_ROLE_OBSERVATION_TAGS = (ObservationTag.NORMALIZED_AST, ObservationTag.CLASS_FAMILY, ObservationTag.METHOD_ROLE)
_NORMALIZED_AST_DATAFLOW_ROOT_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.NORMALIZED_AST, ObservationTag.DATAFLOW_ROOT, ObservationTag.PARTIAL_VIEW)
_NORMALIZED_AST_PARTIAL_VIEW_EXPORT_OBSERVATION_TAGS = (ObservationTag.NORMALIZED_AST, ObservationTag.PARTIAL_VIEW, ObservationTag.EXPORT_MAPPING)
_PARTIAL_VIEW_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.PARTIAL_VIEW, ObservationTag.NORMALIZED_AST)
_PREDICATE_CHAIN_DATAFLOW_ROOT_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.PREDICATE_CHAIN, ObservationTag.DATAFLOW_ROOT, ObservationTag.NORMALIZED_AST)
_PREDICATE_CHAIN_FACTORY_DISPATCH_OBSERVATION_TAGS = (ObservationTag.PREDICATE_CHAIN, ObservationTag.FACTORY_DISPATCH)
_PREDICATE_CHAIN_NORMALIZED_AST_DATAFLOW_ROOT_OBSERVATION_TAGS = (ObservationTag.PREDICATE_CHAIN, ObservationTag.NORMALIZED_AST, ObservationTag.DATAFLOW_ROOT)
_PREDICATE_CHAIN_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.PREDICATE_CHAIN, ObservationTag.NORMALIZED_AST)
_PROJECTION_DICT_BRANCH_DISPATCH_CLOSED_FAMILY_CASES_OBSERVATION_TAGS = (ObservationTag.PROJECTION_DICT, ObservationTag.BRANCH_DISPATCH, ObservationTag.CLOSED_FAMILY_CASES)
_PROJECTION_DICT_CLASS_FAMILY_DATAFLOW_ROOT_OBSERVATION_TAGS = (ObservationTag.PROJECTION_DICT, ObservationTag.CLASS_FAMILY, ObservationTag.DATAFLOW_ROOT)
_PROJECTION_DICT_DATAFLOW_ROOT_BUILDER_CALL_OBSERVATION_TAGS = (ObservationTag.PROJECTION_DICT, ObservationTag.DATAFLOW_ROOT, ObservationTag.BUILDER_CALL)
_PROJECTION_DICT_EXPORT_DATAFLOW_ROOT_OBSERVATION_TAGS = (ObservationTag.PROJECTION_DICT, ObservationTag.EXPORT_MAPPING, ObservationTag.DATAFLOW_ROOT)
_PROJECTION_HELPER_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.PROJECTION_HELPER, ObservationTag.NORMALIZED_AST)
_PROJECTION_HELPER_NORMALIZED_AST_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.PROJECTION_HELPER, ObservationTag.NORMALIZED_AST, ObservationTag.PARTIAL_VIEW)
_REGISTRY_POPULATION_CLASS_FAMILY_MANUAL_REGISTRATION_OBSERVATION_TAGS = (ObservationTag.REGISTRY_POPULATION, ObservationTag.CLASS_FAMILY, ObservationTag.MANUAL_REGISTRATION)
_REGISTRY_POPULATION_CLASS_LEVEL_POSITION_MANUAL_REGISTRATION_OBSERVATION_TAGS = (ObservationTag.REGISTRY_POPULATION, ObservationTag.CLASS_LEVEL_POSITION, ObservationTag.MANUAL_REGISTRATION)
_REGISTRY_POPULATION_RUNTIME_MEMBERSHIP_SEMANTIC_STRING_LITERAL_OBSERVATION_TAGS = (ObservationTag.REGISTRY_POPULATION, ObservationTag.RUNTIME_MEMBERSHIP, ObservationTag.SEMANTIC_STRING_LITERAL)
_REPEATED_METHOD_ROLES_CLASS_FAMILY_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.REPEATED_METHOD_ROLES, ObservationTag.CLASS_FAMILY, ObservationTag.NORMALIZED_AST)
_RUNTIME_TYPE_GENERATION_INTERFACE_IDENTITY_OBSERVATION_TAGS = (ObservationTag.RUNTIME_TYPE_GENERATION, ObservationTag.INTERFACE_IDENTITY)
_RUNTIME_TYPE_GENERATION_LINEAGE_OBSERVATION_TAGS = (ObservationTag.RUNTIME_TYPE_GENERATION, ObservationTag.LINEAGE_MAPPING)
_SCOPED_SHAPE_WRAPPER_NORMALIZED_AST_OBSERVATION_TAGS = (ObservationTag.SCOPED_SHAPE_WRAPPER, ObservationTag.NORMALIZED_AST)
_SEMANTIC_DICT_BAG_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.SEMANTIC_DICT_BAG, ObservationTag.PARTIAL_VIEW)
_SEMANTIC_STRING_LITERAL_PARTIAL_VIEW_OBSERVATION_TAGS = (ObservationTag.SEMANTIC_STRING_LITERAL, ObservationTag.PARTIAL_VIEW)
_SENTINEL_ATTRIBUTE_BRANCH_DISPATCH_CLASS_FAMILY_OBSERVATION_TAGS = (ObservationTag.SENTINEL_ATTRIBUTE, ObservationTag.BRANCH_DISPATCH, ObservationTag.CLASS_FAMILY)
_SENTINEL_TYPE_CAPABILITY_MARKER_OBSERVATION_TAGS = (ObservationTag.SENTINEL_TYPE, ObservationTag.CAPABILITY_MARKER)
_SHARED_ALGORITHM_AUTHORITY_AUTHORITATIVE_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.AUTHORITATIVE_MAPPING)
_SHARED_ALGORITHM_AUTHORITY_AUTHORITATIVE_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.NOMINAL_IDENTITY)
_SHARED_ALGORITHM_AUTHORITY_AUTHORITATIVE_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.PROVENANCE)
_SHARED_ALGORITHM_AUTHORITY_MRO_ORDERING_AUTHORITATIVE_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.MRO_ORDERING, CapabilityTag.AUTHORITATIVE_MAPPING)
_SHARED_ALGORITHM_AUTHORITY_NOMINAL_IDENTITY_AUTHORITATIVE_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.AUTHORITATIVE_MAPPING)
_SHARED_ALGORITHM_AUTHORITY_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.NOMINAL_IDENTITY)
_SHARED_ALGORITHM_AUTHORITY_NOMINAL_IDENTITY_CLASS_LEVEL_REGISTRATION_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.CLASS_LEVEL_REGISTRATION)
_SHARED_ALGORITHM_AUTHORITY_NOMINAL_IDENTITY_FAIL_LOUD_CONTRACTS_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.FAIL_LOUD_CONTRACTS)
_SHARED_ALGORITHM_AUTHORITY_NOMINAL_IDENTITY_UNIT_RATE_COHERENCE_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.UNIT_RATE_COHERENCE)
_SHARED_ALGORITHM_AUTHORITY_PROVENANCE_FAIL_LOUD_CONTRACTS_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.PROVENANCE, CapabilityTag.FAIL_LOUD_CONTRACTS)
_SHARED_ALGORITHM_AUTHORITY_UNIT_RATE_COHERENCE_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.UNIT_RATE_COHERENCE)
_SHARED_ALGORITHM_AUTHORITY_UNIT_RATE_COHERENCE_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.UNIT_RATE_COHERENCE, CapabilityTag.NOMINAL_IDENTITY)
_SHARED_ALGORITHM_AUTHORITY_UNIT_RATE_COHERENCE_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.SHARED_ALGORITHM_AUTHORITY, CapabilityTag.UNIT_RATE_COHERENCE, CapabilityTag.PROVENANCE)
_SHARED_TYPE_NAMESPACE_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.SHARED_TYPE_NAMESPACE, CapabilityTag.NOMINAL_IDENTITY)
_STRING_DISPATCH_CLOSED_FAMILY_CASES_OBSERVATION_TAGS = (ObservationTag.STRING_DISPATCH, ObservationTag.CLOSED_FAMILY_CASES)
_STRING_DISPATCH_SEMANTIC_STRING_LITERAL_CLASS_FAMILY_OBSERVATION_TAGS = (ObservationTag.STRING_DISPATCH, ObservationTag.SEMANTIC_STRING_LITERAL, ObservationTag.CLASS_FAMILY)
_TYPE_LINEAGE_PROVENANCE_BIDIRECTIONAL_NORMALIZATION_CAPABILITY_TAGS = (CapabilityTag.TYPE_LINEAGE, CapabilityTag.PROVENANCE, CapabilityTag.BIDIRECTIONAL_NORMALIZATION)
_UNIT_RATE_COHERENCE_AUTHORITATIVE_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.UNIT_RATE_COHERENCE, CapabilityTag.AUTHORITATIVE_MAPPING, CapabilityTag.NOMINAL_IDENTITY)
_VIRTUAL_MEMBERSHIP_NOMINAL_IDENTITY_CAPABILITY_TAGS = (CapabilityTag.VIRTUAL_MEMBERSHIP, CapabilityTag.NOMINAL_IDENTITY)
_VIRTUAL_MEMBERSHIP_NOMINAL_IDENTITY_PROVENANCE_CAPABILITY_TAGS = (CapabilityTag.VIRTUAL_MEMBERSHIP, CapabilityTag.NOMINAL_IDENTITY, CapabilityTag.PROVENANCE)
...
def _try_except_registry_lookup_shape(
    ...
    if key_expr is None:
        return None
    raise_stmt = next(
        (stmt for stmt in lookup_body.handler.body if isinstance(stmt, ast.Raise)),
        None,
    )
...
def _membership_guard_registry_lookup_shape(
    ...
    if returned_key != lookup_body.key_expr:
        return None
    raise_stmt = next(
        (stmt for stmt in lookup_body.guard.body if isinstance(stmt, ast.Raise)),
        None,
    )
    return RegistryLookupShape(
