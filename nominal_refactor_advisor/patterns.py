...
PatternSpec = product_record(
    ...
    defaults={
        ...
        "dependencies": (),
        "synergy_with": (),
        "plan_step_builder_id": None,
        "action_builder_id": None,
    },
    doc="Documentation payload for one canonical refactoring pattern.",
)
